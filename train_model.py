...
def test(model, device, test_loader, criterion, hook):
    '''
...
def train(model, device, dataloaders, criterion, optimizer, scheduler, args, hook):
    '''
...
def main(args):
    ...
    '''
    model = train(model, device, train_loader, loss_criterion, optimizer, exp_lr_scheduler, args, hook)
    
    '''
    TODO: Test the model to see its accuracy
    '''
    test(model, device, test_loader, loss_criterion, hook)
